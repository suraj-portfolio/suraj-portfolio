    ...
    data: [
      {
        ...
        years: "2013-04 - 2015-06",
      },
      {
        university: "Shivaji University",
        qualification: "Bachelor of Engineering",
        years: "2007-06 - 2011-05",
      },
    ],
  },
  {
    ...
    data: [
      {
        ...
        years: "2022-05 - Present",
      },
      {
        company: "Persistent Systems",
        role: "Front end Developer",
        years: "2019-12 - 2022-05",
      },
      {
        company: "Infosys",
        role: "Software Developer",
        years: "2019-04 - 2019-10",
      },
      {
        company: "Accenture",
        role: "Application Development Analyst",
        years: "2018-06 - 2019-04",
      },
    ],
  },
];
...
const skillData = [
  {
    ...
    data: [
      ...
      {
        name: "Javascript, React, Typescript, Jest, NodeJs",
      },
      {
...
const About = () => {
  const getData = (arr: Qualifications[], title: string) => {
        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="hidden xl:flex flex-1 relative">
            <DevImg
              ...
              imgSrc="https://ik.imagekit.io/rgsrmkbhv/developer.png"
            />
          </div>
          {/* tabs */}
